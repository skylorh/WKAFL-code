...
f_log = open("log_MNIST_TWAFL.txt", "w")
...
with open('./results/MNIST_TWAFL_testacc.txt', 'a+') as fl:
    fl.write(
        '\n' + date + ' Results (UN is {}, K is {}, classnum is {}, BZ is {}, CB is {}, LR is {}, itr_test is {}, total itr is {})\n'.
        format(args.user_num, args.K, args.classes, args.batch_size, args.CB, args.lr, args.itr_test,
               args.total_iterations))
    fl.write('TWAFL: ' + str(logs['test_acc']))

with open('./results/MNIST_TWAFL_trainloss.txt', 'a+') as fl:
...
with open('./results/MNIST_TWAFL_testloss.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, itr_test is {}, total itr is {})\n'.
             format(args.user_num, args.K, args.batch_size, args.lr, args.itr_test, args.total_iterations))
