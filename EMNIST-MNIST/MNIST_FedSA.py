...
class Argument():
    def __init__(self):
        ...
        self.lr = 0.005  # learning rate of global model 0.0005
...
for itr in range(1, args.total_iterations + 1):
    ...
    #     # 增加区分度
    #     # _pi[useri] += worker_idx * worker_idx
