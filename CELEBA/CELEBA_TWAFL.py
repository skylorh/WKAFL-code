...
with open('./results/CELEBA_TWAFL_testloss.txt', 'a+') as fl:
...
with open('./results/CELEBA_TWAFL_testacc.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, total itr is {}, itr_test is {})\n'.
             format(args.users_total, args.K, args.batch_size, args.lr, args.itr_numbers, args.log_test))
    fl.write('TWAFL: ' + str(logs['test_acc']))

with open('./results/CELEBA_TWAFL_trainloss.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, total itr is {}, itr_test is {})\n'.
             format(args.users_total, args.K, args.batch_size, args.lr, args.itr_numbers, args.log_test))
