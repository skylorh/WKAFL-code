...
class Argument():
    def __init__(self):
        ...
        self.K = 40  # number of participant clients K
...
f_log = open("log_cifar10_MNIST_SASGD.txt", "w")
...
with open('./results/cifar10_SASGD_testacc.txt', 'a+') as fl:
    fl.write(
...
with open('./results/cifar10_SASGD_testloss.txt', 'a+') as fl:
    fl.write(
        '\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, total itr is {}, itr_test is {}, classNum is {})\n'.
        format(args.user_num, args.K, args.batch_size, args.lr, args.total_iterations, args.itr_test, args.classNum))
    fl.write('testloss: ' + str(logs['test_loss']))

with open('./results/cifar10_SASGD_trainloss.txt', 'a+') as fl:
    fl.write(
        '\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, total itr is {}, itr_test is {}, classNum is {})\n'.
        format(args.user_num, args.K, args.batch_size, args.lr, args.total_iterations, args.itr_test, args.classNum))
