...
f_log = open("log_EMNIST_ByClass_EMNIST_TWAFL.txt", "w")
...
for itr in range(1, args.total_iterations + 1):
    ...
    Collect_Gradients = ZerosGradients(Layers_shape, device=device)
...
with open('./results/FEMNIST_TWAFL_testacc.txt', 'a+') as fl:
...
with open('./results/FEMNIST_TWAFL_testloss.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, total itr is {}, itr_test is {})\n'.
             format(args.user_num, args.K, args.batch_size, args.lr, args.total_iterations, args.itr_test))
    fl.write('testloss: ' + str(logs['test_loss']))

with open('./results/FEMNIST_TWAFL_trainloss.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (UN is {}, K is {}, BZ is {}, LR is {}, total itr is {}, itr_test is {})\n'.
             format(args.user_num, args.K, args.batch_size, args.lr, args.total_iterations, args.itr_test))
